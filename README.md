# 🏆 World Cup 2026 — استراحة 6 Predictions

A private prediction game for the استراحة 6 group (works for more too).
...
4. *(Recommended for the group)* Open **Authentication → Providers → Email** and
